...
class RouteCardThreeMetro extends StatelessWidget {
  ...
  final String thirdMetro;
  final String thirdDirection;
  final String thirdDeparture;
  final String thirdArrival;
  final List<String> thirdIntermediateStations;
  final List<List<List<int>>> serializedData;
  var firstLineIsExpanded;
  var secondLineIsExpanded;
  var thirdLineIsExpanded;
  ...
  RouteCardThreeMetro({
    ...
    required this.thirdMetro,
    required this.thirdDirection,
    required this.thirdDeparture,
    required this.thirdArrival,
    required this.thirdIntermediateStations,
    required this.serializedData,
    required this.firstLineIsExpanded,
    required this.secondLineIsExpanded,
    required this.thirdLineIsExpanded,
  }) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(() => _buildMetroSection(
                    ...
                    Colors.green,
                    "Metro 3",
                    thirdLineIsExpanded.value,
                    () {
                      thirdLineIsExpanded.value = !thirdLineIsExpanded.value;
                    },
                  )),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Icon(
            Icons.circle,
            color: isMajor ? Colors.green : Colors.grey,
            size: 14,
          ),
          const SizedBox(width: 10),
          Expanded(
